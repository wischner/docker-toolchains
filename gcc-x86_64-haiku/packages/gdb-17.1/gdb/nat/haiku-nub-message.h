...
HAIKU_ASSOCIATE_MESSAGE_DATA_WITH_REPLY (B_DEBUG_MESSAGE_START_PROFILER,
                                         debug_nub_start_profiler);
HAIKU_ASSOCIATE_MESSAGE_DATA (B_DEBUG_MESSAGE_STOP_PROFILER, debug_nub_stop_profiler);
HAIKU_ASSOCIATE_MESSAGE_DATA_WITH_REPLY (B_DEBUG_MESSAGE_WRITE_CORE_FILE,
