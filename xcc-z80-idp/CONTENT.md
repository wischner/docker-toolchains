...
installed in `wischner/xcc-z80-idp:2.1.1`. The image is based on Ubuntu 24.04
...
| --- | --- | --- |
| Image | 2.1.1 | This package |
| XCC Z80 toolchain | 2.1.1 | Inherited from `wischner/xcc-z80:2.1.1` |
...
The complete XCC 2.1.1 suite is installed in `/opt/x/bin`:
...
XEMU remains version 2.1.1, with a small downstream extension that allows a
...
```text
/opt/x/                         XCC 2.1.1 host and Z80 toolchain
